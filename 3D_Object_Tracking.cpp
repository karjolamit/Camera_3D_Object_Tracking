...
int main(int argc, const char *argv[])
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        if (dataBuffer.size() > 1) //  at least two images must have been processed
        {
            ...
            // Selectable for brute force (BF) or Fast Library for Approximate Nearest Neighbors (FLANN) 
            string matcherType = "MAT_BF";
            // string matcherType = "MAT_FLANN";
            
            // Selecting description category as binary (BINARY) or histogram of gradients (HOG) 
            ...
            // Selecting nearest neighbors (NN) or k nearest neighbors (KNN) 
